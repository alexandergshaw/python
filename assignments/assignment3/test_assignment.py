...
class StudentCodeTests(unittest.TestCase):
    ...
    def test_count_active_days_some(self):
        self.assertEqual(self.module.count_active_days([1000, 5000, 8000], 4000), 2)

    def test_count_active_days_none(self):
        self.assertEqual(self.module.count_active_days([1, 2, 3], 10), 0)

    def test_count_active_days_all_including_equal_goal(self):
        # Reaching the goal exactly should count.
        self.assertEqual(self.module.count_active_days([10, 10], 5), 2)
        self.assertEqual(self.module.count_active_days([5, 6, 7], 5), 3)

    def test_count_active_days_empty(self):
        self.assertEqual(self.module.count_active_days([], 5), 0)
