...
class StudentCodeTests(unittest.TestCase):
    ...
    def test_total_items(self):
        self.assertEqual(self.module.total_items({"apples": 2, "milk": 3}), 5)
        self.assertEqual(self.module.total_items({"a": 1, "b": 1, "c": 1}), 3)
        self.assertEqual(self.module.total_items({}), 0)

    def test_item_names_sorted(self):
        self.assertEqual(self.module.item_names({"milk": 1, "apples": 2}), ["apples", "milk"])
        self.assertEqual(self.module.item_names({"c": 1, "a": 2, "b": 3}), ["a", "b", "c"])
        self.assertEqual(self.module.item_names({}), [])
