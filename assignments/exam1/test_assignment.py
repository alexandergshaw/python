...
class StudentCodeTests(unittest.TestCase):
    ...
    def test_classify_number(self):
        self.assertEqual(self.module.classify_number(-4), "negative")
        self.assertEqual(self.module.classify_number(0), "zero")
        self.assertEqual(self.module.classify_number(7), "positive")

    def test_sum_even(self):
        self.assertEqual(self.module.sum_even([1, 2, 3, 4]), 6)
        self.assertEqual(self.module.sum_even([1, 3, 5]), 0)
        self.assertEqual(self.module.sum_even([2, 4, 6]), 12)
        self.assertEqual(self.module.sum_even([]), 0)
