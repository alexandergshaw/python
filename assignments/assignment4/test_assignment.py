...
class StudentCodeTests(unittest.TestCase):
    ...
    def test_average(self):
        ...
        self.assertEqual(self.module.average([10]), 10)
        self.assertEqual(self.module.average([]), 0)

    def test_above_average_count(self):
        self.assertEqual(self.module.above_average_count([2, 4, 6]), 1)
        self.assertEqual(self.module.above_average_count([10, 10, 10]), 0)
