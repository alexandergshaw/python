...
class StudentCodeTests(unittest.TestCase):
    ...
    def test_budget_status_under(self):
        self.assertEqual(self.module.budget_status(40, 60), "under")
        self.assertEqual(self.module.budget_status(0, 1), "under")

    def test_budget_status_over(self):
        self.assertEqual(self.module.budget_status(75, 60), "over")
        self.assertEqual(self.module.budget_status(100, 99), "over")

    def test_budget_status_exact(self):
        self.assertEqual(self.module.budget_status(60, 60), "exact")
        self.assertEqual(self.module.budget_status(0, 0), "exact")
